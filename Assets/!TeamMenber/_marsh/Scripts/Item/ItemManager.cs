...
public class ItemManager : SystemObject<ItemManager> {
    ...
    public override void Initialize() {
        ...
        itemList.Add(new HealItem("めっちゃ毒", 3003, -50, potionIcon));
        itemList.Add(new MaxHpBoost("HP最大値上昇薬", 3004, 50, potionIcon));
        ...
        itemList.Add(new BaseAttackBoost("灼熱に伝わる石", 4023, 200,FireStone));
        itemList.Add(new BaseAttackBoost("森に伝わる石", 4024, 200,ForestStone));
        itemList.Add(new BaseDefenceBoost("大地に伝わる石", 4025, 200, SandStone));
        ...
        weaponList.Add(new WeaponBase("普通の剣", 1001, 70,30,1.2f, swordIcon));
        weaponList.Add(new WeaponBase("魔剣ズルフィカール", 1004, 500,50,1.5f, BloodSword));
        weaponList.Add(new WeaponBase("天上天下唯我独尊ブレード", 1005, 5000,90,1.7f, MgicSword));
        ...
        armorList.Add(new ArmorBase("ニードルアーマー", 2004, 10, NomarArmor));
        armorList.Add(new ArmorBase("スピードアーマー", 2005, 20, NomarArmor));
