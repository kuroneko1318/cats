...
public class BeefEnemy1 : EnemyBase
{
    ...
    private IEnumerator AttackRoutine() {
        ...
        switch (rand) {
            case 0: PerformAttack("Attack1", 0.2f, 1.5f); break;
            case 1: PerformAttack("Attack2", 0.3f, 1.5f); break;
            case 2: PerformAttack("Attack3", 0.25f, 1.5f); break;
        }

        // 攻撃モーション分待つ（AnimationEvent で処理する場合はモーション長に合わせる）
        yield return new WaitForSeconds(1.7f); // 最大攻撃時間に合わせる
